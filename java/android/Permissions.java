...
/**
 * Created by Alisson on 23/03/2017.
 */
...
public class Permissions implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    // Constructor
    public Permissions(Executable executable) {
     ...
     */
    public void executeWithPermissions(Activity activity, String permissionName, int permissionId) {
        ...
        if (ContextCompat.checkSelfPermission(activity, permissionName) !=
            ...
            ActivityCompat.requestPermissions(activity,
                    new String[]{ permissionName }, this.permissionId);
        } else {
            // Execute onPermissionGranted from the requester
            executable.onPermissionGranted();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        // Check requestCode against permissionId
